      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          ...
          >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <select
                    ...
                    className="text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-700 focus:outline-none sm:flex-1"
                  ...
                  >
                    ...
                    <option value="Allabad">Allied Bank</option>
                  </select>
                  <input
                    type="text"
            ...
            <button
              className="bg-[#672bd6] w-[420px] font-semibold hover:bg-[#54428E] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white mx-auto lg:w-[640px] my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
